...
public class ComponentService {
     ...
     */
    public void renameHtmlFilePath(Component component, String newHtmlFilePath) throws IOException {
        ...
        // Rename HTML file
        ioUtils.renameHtmlFile(component.getHtmlFilePath(), newHtmlFilePath, component.getStudy().getDirName());
        component.setHtmlFilePath(newHtmlFilePath);
        componentDao.update(component);
    }
