...
public class PublixErrorMessages {
    ...
    public static String workerTypeNotAllowed(String workerType, Long studyId, Long batchId) {
    ...
    public String groupNotFoundForReassigning(Long studyResultId) {
        return "Couldn't reassign the study result with ID " + studyResultId + " to any other group.";
    }

    public static String groupStudyResultNotMember(Long studyResultId) {
        return "The study result with ID " + studyResultId + " isn't member in any group.";
    }
