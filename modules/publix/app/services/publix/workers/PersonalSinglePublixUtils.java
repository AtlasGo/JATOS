 ...
 */
@Singleton
public class PersonalSinglePublixUtils extends PublixUtils<PersonalSingleWorker> {

    @Inject
    PersonalSinglePublixUtils(ResultCreator resultCreator, IdCookieService idCookieService,
            GroupAdministration groupAdministration, PersonalSingleErrorMessages errorMessages, StudyDao studyDao,
    ...
    @Override
    public PersonalSingleWorker retrieveTypedWorker(Long workerId) throws ForbiddenPublixException {
    ...
    public PersonalSingleWorker retrieveTypedWorker(String workerIdStr) throws ForbiddenPublixException {
        if (workerIdStr == null) {
