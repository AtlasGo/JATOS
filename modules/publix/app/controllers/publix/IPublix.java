...
public interface IPublix {
     ...
     */
    Result startStudy(Request request, Long studyId, Long batchId) throws PublixException;
     ...
     */
    Result startComponent(Request request, Long studyId, Long componentId, Long studyResultId) throws PublixException;
     ...
     */
    Result startComponentByPosition(Request request, Long studyId, Integer position, Long studyResultId)
     ...
     */
    Result startNextComponent(Request request, Long studyId, Long studyResultId) throws PublixException;
     ...
     */
    Result getInitData(Request request, Long studyId, Long componentId, Long studyResultId)
     ...
     * The study session data are different from Play's session and stored within the study results.
     */
    Result setStudySessionData(Request request, Long studyId, Long studyResultId) throws PublixException;
     ...
     */
    Result heartbeat(Request request, Long studyId, Long studyResultId) throws PublixException;
     ...
     */
    Result submitResultData(Request request, Long studyId, Long componentId, Long studyResultId) throws PublixException;
     ...
     * and component ID.
     */
    Result appendResultData(Request request, Long studyId, Long componentId, Long studyResultId) throws PublixException;
     ...
     */
    Result finishComponent(Request request, Long studyId, Long componentId, Long studyResultId, Boolean successful,
     ...
     */
    Result abortStudy(Request request, Long studyId, Long studyResultId, String message) throws PublixException;

    /**
     * HTTP type: Normal or Ajax GET request
     * <p>
     * Finishes the study with the given ID (StudyResult state will be FINISHED or FAIL). Optionally it can be specified
     * whether the study was successful and an error message.
     */
    Result finishStudy(Request request, Long studyId, Long studyResultId, Boolean successful, String errorMsg)
            throws PublixException;
     ...
     */
    Result log(Request request, Long studyId, Long componentId, Long studyResultId) throws PublixException;
